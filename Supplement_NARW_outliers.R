...
vcf <- read.vcfR("/Users/richardorton/Desktop/annotated.autosomes.NARW.segregating.parsed.vcf")
...
radiator::detect_genomic_format(data = "/Users/richardorton/Desktop/annotated.autosomes.NARW.segregating.parsed.vcf")

genomic_converter(data = "/Users/richardorton/Desktop/annotated.autosomes.NARW.segregating.parsed.vcf",
                  output = c("bayescan"), filename="/Users/richardorton/Desktop/bayescan.input",
                  parallel.core = parallel::detectCores() - 4)
